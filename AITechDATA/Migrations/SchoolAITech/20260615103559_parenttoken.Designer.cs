...
namespace AITechDATA.Migrations.SchoolAITech
{
    ...
    [Migration("20260615103559_parenttoken")]
    partial class parenttoken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AITechDATA.Domain.Duty", b =>
                {
                    ...
                    b.Property<DateTime?>("DutyDoneDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AITechDATA.Domain.SchoolRegistration", b =>
                {
                    ...
                    b.Property<long>("FatherParentId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("MotherParentId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FatherParentId");

                    b.HasIndex("MotherParentId");
            ...
            modelBuilder.Entity("AITechDATA.Domain.SecurePlayerDevice", b =>
                {
                    ...
                    b.ToTable("SecurePlayerDevices", "dbo");
                });
            ...
            modelBuilder.Entity("AITechDATA.Domain.SecurePlayerViewLog", b =>
                {
                    ...
                    b.ToTable("SecurePlayerViewLogs", "dbo");
                });
            ...
            modelBuilder.Entity("AITechDATA.Domain.TimeBreak", b =>
                {
                    ...
                    b.Property<TimeSpan>("TimeBreakEndTime")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("TimeBreakStartTime")
                        .HasColumnType("time");

                    b.Property<long>("TimeFunctionId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AITechDATA.Domain.TimeFunction", b =>
                {
                    ...
                    b.Property<DateTime>("TimeFunctionStartDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AITechDATA.Domain.User", b =>
                {
                    ...
                    b.Property<bool>("InvitationRewardApplied")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("InvitationRewardAppliedDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool?>("IsFeaturedTeacher")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AITechDATA.Domain.SchoolRegistration", b =>
                {
                    b.HasOne("AITechDATA.Domain.Parent", "FatherParent")
                        .WithMany()
                        .HasForeignKey("FatherParentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AITechDATA.Domain.Parent", "MotherParent")
                        .WithMany()
                        .HasForeignKey("MotherParentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("AITechDATA.Domain.TimeBreak", b =>
                {
                    b.HasOne("AITechDATA.Domain.TimeFunction", "TimeFunction")
                        .WithMany("TimeBreaks")
                        .HasForeignKey("TimeFunctionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TimeFunction");
                });
