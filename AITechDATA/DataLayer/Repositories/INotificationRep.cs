...
namespace AITechDATA.DataLayer.Repositories
{
    ...
    {
        Task<ListResultObject<Notification>> GetAllNotificationsAsync(long userId = 0, long senderUserId = 0, int pageIndex = 1, int pageSize = 20, string searchText = "",string sortQuery ="");
