...
namespace AITechDATA.DataLayer.Repositories
{
    ...
    {
        Task<UserListCustomResponse<User>> GetAllUsersAsync(long groupId=0,long courseId =0, long sessionAssignmentId=0,long sessionId=0, long AddressId = 0, List<long>? RoleIds = null,string StudyField= "",string EducationalGrade ="", int pageIndex = 1, int pageSize = 20, string searchText = "", string sortQuery = "");
