...
namespace AITechDATA.DataLayer.Repositories
{
    ...
    {
        Task<ListResultObject<PaymentHistory>> GetAllPaymentHistoriesAsync(long GroupId = 0, long UserId = 0, int pageIndex = 1, int pageSize = 20, string searchText = "", string sortQuery = "");
