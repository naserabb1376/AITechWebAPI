    ...
    public class DismissalController : ControllerBase
    {
        ...
        public async Task<ActionResult<BitResultObject>> AddDismissal_Base(AddEditDismissalRequestBody requestBody)
        {
            ...
            Dismissal Dismissal = new Dismissal()
            {
                ...
                UserId = (requestBody.UserID == null || requestBody.UserID.Value <= 0) ? User.GetCurrentUserId() : requestBody.UserID.Value,
                CheckerUserId = (requestBody.CheckerUserID != null && requestBody.CheckerUserID <= 0) ? User.GetCurrentUserId() : requestBody.CheckerUserID,
